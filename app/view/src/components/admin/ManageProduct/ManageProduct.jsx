...
function ManageProduct() {
  ...
  const handelSubmitDelete = () => {
    deleteProduct(id);
    setTimeout(() => requireProductList(setProductList), 100);
    setOpen(false);
  };
  const handleClose = () => {
    setOpen(false);
    ...
    <div id="product" className="w-100">
      <div className="manage-product">
        ...
        <div className="list-activity">
          <h2>Product</h2>
          <div onClick={toggle}>
            <i className="far fa-plus-square"></i> <h4>Add new product</h4>
          </div>
        </div>
            ...
            <tbody>
              {productList.map(
                (product, index) =>
                  ...
                  product.pName
                    .toLocaleLowerCase()
                    .indexOf(filterSearch.trim().toLocaleLowerCase()) !== -1 &&
                  ((filter !== "" && filter !== "All") ||
                  ...
                  ((filter !== "" && filter !== "All") ||
                    ...
                    <tr key={index}>
                      ...
                      <td>{product.price}</td>
                      <td onClick={() => handleClickOpen(product.id)}>
                        <i className="far fa-trash-alt"></i>
                      </td>
                      <td onClick={() => handleToggleEdit(product.id)}>
