            ...
            <div class="col-lg-8 col-xxl-6">
              <div class="text-center my-5">
                <h1 class="fw-bolder mb-3">
                  SỨ MỆNH CỦA CHÚNG TÔI LÀ ĐEM ĐẾN NHỮNG SẢN PHẨM TỐT NHẤT CHO
                  NGƯỜI TIÊU DÙNG{" "}
                </h1>
        ...
        <div class="container px-5 my-5">
          <div class="row gx-5 align-items-center">
            <div class="col-lg-6 order-first order-lg-last">
              <img
                class="img-fluid rounded mb-5 mb-lg-0"
                src="https://cdn.tgdd.vn/Products/Images/44/251426/laptop-gigabyte-gaming-g5-i5-5s11130sh-1.jpg"
                alt="..."
              />
            </div>
            <div class="col-lg-6">
              <h2 class="fw-bolder">
                HỆ THỐNG CHUYÊN BÁN NHỮNG LAPTOP HOT NHẤT HIỆN NAY
              </h2>
              <p class="lead fw-normal text-muted mb-0">
                Tác chiến trên mọi chiến trường ảo một cách đầy thuận lợi cùng
                laptop GIGABYTE Gaming G5 i5 (5S11130SH), với kiểu dáng mạnh mẽ
                cùng hiệu năng tân tiến, sẵn sàng đồng hành cùng bạn ở bất kỳ
                đâu.
              </p>
            </div>
          </div>
